...
class HomeworkPlatform:
    ...
    def parse_date(self, date_str):
        ...
        # 如果标准格式都失败，尝试处理单数字日期（如9/11/2025）
    ...
    def build_about_tab(self, parent):
        ...
        # 版本信息
        version_label = ctk.CTkLabel(parent, text="版本 2.5", 
                                    font=ctk.CTkFont(size=18))
...
https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.zh-hans"""
    ...
    def add_homework(self):
        ...
        # 标准化日期格式
        normalized_create = self.format_date(create_date_obj)
        normalized_due = self.format_date(due_date_obj)
    ...
    def query_homework(self):
        ...
        if not query_date_obj:
            messagebox.showerror("错误", "查询日期格式不正确！请使用 DD/MM/YYYY 或 D/M/YYYY 格式")
            return
